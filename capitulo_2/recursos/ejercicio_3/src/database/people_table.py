...
class People(Base):
    ...
    def get_json(data, data_planet):
        ...
        tmp['mass'] = data.mass
        tmp['hair_color'] = data.hair_color
        tmp['skin_color'] = data.skin_color
        tmp['eye_color'] = data.eye_color
        tmp['birth_year'] = data.birth_year
        tmp['gender'] = data.gender
        tmp['planet'] = Planet.get_json(data_planet)
