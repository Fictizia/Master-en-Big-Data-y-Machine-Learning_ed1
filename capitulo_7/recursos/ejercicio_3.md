...
## Capítulo 7 - Ejercicio 01: Creando redes convolucionales ##

El objetivo de este ejercicio es crear una red convolucional mediante la utilización de TensorFlow. Para ello construiremos un contenedor que despligue un servidor de Jupyter notebooks mediante el cual podremos crear de forma sencilla nuestra red convolucional.
